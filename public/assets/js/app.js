! function(s) {
    ...
    function a(e) {
        document.getElementById("header-lang-img") && ("eng" == e ? document.getElementById("header-lang-img").src = "assets/img/flags/us.jpg" : "sp" == e ? document.getElementById("header-lang-img").src = "assets/img/flags/spain.jpg" : "gr" == e ? document.getElementById("header-lang-img").src = "assets/img/flags/germany.jpg" : "it" == e ? document.getElementById("header-lang-img").src = "assets/img/flags/italy.jpg" : "ru" == e && (document.getElementById("header-lang-img").src = "assets/img/flags/russia.jpg"), localStorage.setItem("language", e), null == (t = localStorage.getItem("language")) && a(n), s.getJSON("assets/lang/" + t + ".json", function(e) {
